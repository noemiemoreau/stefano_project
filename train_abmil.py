...
def get_args():
    ...
    parser.add_argument('--learning_rate', dest="learning_rate", type=float, nargs='?', default=5e-9, help='Learning rate')
    ...
    parser.add_argument('--img_size', dest='img_size', type=int, default=9400, help='Input image size for the model')
